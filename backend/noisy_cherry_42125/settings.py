"""
Django settings for noisy_cherry_42125 project.
...
ROOT_URLCONF = 'noisy_cherry_42125.urls'
...
WSGI_APPLICATION = 'noisy_cherry_42125.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_cherry_42125 API",
    "DESCRIPTION": "API documentation for noisy_cherry_42125 App",
    "VERSION": "v1",
}
